...
export default function ZenProductivity() {
      ...
      <div style={{display:"flex", width:'100%',  flexDirection:"column"}}>
        ...
        <div style={{display:"flex", flexDirection:"row", justifyContent: "space-evenly", width: '100%', alignItems: 'start', marginTop:'5%'}}>
          <div style={{display:"flex", flexDirection:"column", width:'40%'}}>
            ...
            <span style={{fontSize:'3vw', fontWeight:'bold', marginTop:'2%'}}>Zen Productivity</span>
            <span style={{fontSize:'1vw', marginTop:'2%'}}>Elevating Mental Health for New Grads</span>
            <span style={{marginTop:'2%', fontStyle: 'italic'}}>Fall 2023</span>
            ...
            <div style={{display:'flex', flexDirection:'row', width:'100%', justifyContent:'space-between', marginTop:'2%'}}>
              <div style={{display:'flex', flexDirection:'column'}}>
                ...
                <span>Ameen Qureshi</span>
              </div>
              <div style={{display:'flex', flexDirection:'column'}}>
                <span style={{fontWeight:'bold'}}>Designers</span>
                <span>Jamie</span>
                <span>Azam Modan</span>
              </div>
              <div style={{display:'flex', flexDirection:'column'}}>
